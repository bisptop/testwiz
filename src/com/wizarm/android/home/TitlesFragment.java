...
public class TitlesFragment extends ListFragment implements ActionBar.TabListener {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
      ...
      //  Directory.initializeDirectory();
        for (int i = 0; i < 4/*Directory.getCategoryCount()*/; i++) {
            bar.addTab(bar.newTab().setText("HI Menu"/*Directory.getCategory(i).getName()*/)
                    .setTabListener(this));
        }
    ...
    public void populateTitles(int category) {
        //fahad DirectoryCategory cat = Directory.getCategory(category);
        String[] items = new String[1/*cat.getEntryCount()*/];
        for (int i = 0; i < 1/*cat.getEntryCount()*/; i++)
            items[i] ="Button_FDK";//cat.getEntry(i).getName();
